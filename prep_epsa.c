...
extern int prep_p_prolog(job_env_t* job_env, slurm_cred_t *cred)
{
    ...
    slurm_info("Job Id: %u", EPS_JOB_ID(job_env));
    ...
    int shmfd;
    char* shm_name = get_shared_memory_region_name(EPS_JOB_ID(job_env));
...
extern int prep_p_epilog(job_env_t* job_env, slurm_cred_t *cred)
{
    ...
    slurm_info("Obtaining semaphores...");
    char* sem_efp_name = get_sem_efp_name(EPS_JOB_ID(job_env));
    ...
    char* sem_exit_name = get_sem_exit_name(EPS_JOB_ID(job_env));
